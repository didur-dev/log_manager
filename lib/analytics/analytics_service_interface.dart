...
abstract class AnalyticsServiceInterface {
  ...
  /// ```dart
  /// Log.analytics.log(PostScoreEvent(score: 777, level: 5, character: 'Dash'));
  /// ```
  /// See also:
  /// * [AnalyticsEvent] - an interface that allows you to create typed analytics events.
  ...
  /// Log this event when the user starts viewing the application screen [name] (and possibly [screenClass]) and the [namePrevious] route.
